...
MC_Json MC_Json::Parse(ParsingContext& aCtxt)
{
	...
	case 'n':
	{
        MC_ASSERT(strncmp((const char*)aCtxt.myPtr, "ull", 3) == 0);
		aCtxt.myPtr += 4;
	}break;
	case '\"':
	{
